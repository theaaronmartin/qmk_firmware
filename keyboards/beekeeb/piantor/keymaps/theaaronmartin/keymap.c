...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x5_3(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SCLN,
                                   QK_LEAD, LT(NAV, KC_TAB),    KC_LSFT,    LALT_T(KC_SPC),  LT(SYM, KC_ESC),     KC_LCTL
    ),
    ...
    //                                KC_LALT, NAV,    KC_LSFT,           KC_SPC,  SYM,     KC_LCTL
    // ),
    ...
    [_NAV] = LAYOUT_split_3x5_3(
        KC_TAB,     KC_LSFT,    KC_MS_BTN4, KC_MS_BTN5, KC_MS_BTN3,            KC_NO,   KC_NO, KC_UP,   KC_NO,  KC_DEL,
        KC_LCTL, KC_MS_WH_UP, KC_MS_WH_DOWN, KC_MS_BTN1, KC_MS_BTN2,           KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC,
        KC_ESC,     KC_LGUI,       KC_LALT,     KC_ENT,    KC_CAPS,           KC_HOME, KC_PGDN, KC_PGUP,  KC_END,  KC_ENT,
